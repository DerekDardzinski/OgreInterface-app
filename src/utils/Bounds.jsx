...
const isOrthographic = (def) => def.isOrthographicCamera

const context = React.createContext()

export function Bounds({ children, damping = 6, fit, clip, margin = 1.2, eps = 0.01, fixedOrientation = false }) {
