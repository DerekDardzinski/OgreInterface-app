...
function ThemeSelector() {
    ...
    themeNames.forEach((value, index) => {
        themesButtons.push(
            <ThemeButton themeName={value} theme={theme} setTheme={setTheme} key={index} id={index} />
        )
    })
	...
	return (
			<div className='dropdown dropdown-bottom'>
                <div className="outline outline-1 outline-base-content rounded-2xl m-1">
				<label tabIndex={0} className='btn rounded-2xl w-[100%] h-[100%]'>
                <svg
					xmlns='http://www.w3.org/2000/svg'
					width='16'
					height='16'
				...
				<div className='dropdown-content bg-base-200 text-base-content rounded-box top-px max-h-96 w-56 overflow-y-auto shadow scrollbar scrollbar-w-1 scrollbar-thumb-rounded-full scrollbar-thumb-accent'>
