...
function DisplayCard(props) {
	return (
		<div className='aspect-square bg-base-200 rounded-xl shadow-lg shadow-base-300 hover:shadow-base-300 hover:shadow-xl outline outline-1 outline-base-content'>
